...
02:49:17 ubuntu@0d1aa73ff9e0 dev-env ±|main|→ time ./build.sh
...
==> qemu.noble: https://cloud-images.ubuntu.com/noble/current/noble-server-cloudimg-amd64.img?checksum=sha256%3Ae61484705035cd64d8e79c35d6f674acccf03ef9c6939ca50dea8a4fdc7eabeb => /home/ubuntu/.cache/packer/70cab9f90ea296d68aed48df557bb0a8e2d44e50.iso
==> qemu.noble: Copying hard drive...
==> qemu.noble: Resizing hard drive...
==> qemu.noble: Starting HTTP server on port 8648
==> qemu.noble: Found port for communicator (SSH, WinRM, etc): 3596.
...
==> qemu.noble: Connecting to VM via VNC (127.0.0.1:5950)
...
==> qemu.noble: Executing Ansible: ansible-playbook -e packer_build_name="noble" -e packer_builder_type=qemu -e packer_http_addr=10.0.2.2:8648 --ssh-extra-args '-o IdentitiesOnly=yes' --scp-extra-args '-O' -e ansible_ssh_private_key_file=/tmp/ansible-key1504585628 -i /tmp/packer-provisioner-ansible1858435978 /dev-env/packer/ansible/playbook.yaml
    qemu.noble:
    qemu.noble: PLAY [play Hello World] ********************************************************
    qemu.noble:
    qemu.noble: TASK [task Hello World] ********************************************************
    qemu.noble: [WARNING]: Platform linux on host default is using the discovered Python
    qemu.noble: interpreter at /usr/bin/python3.12, but future installation of another Python
    qemu.noble: interpreter could change the meaning of that path. See
    qemu.noble: https://docs.ansible.com/ansible-
    qemu.noble: core/2.17/reference_appendices/interpreter_discovery.html for more information.
...
Build 'qemu.noble' finished after 20 minutes 31 seconds.

==> Wait completed after 20 minutes 31 seconds
...
user    21m32.208s
sys     1m23.286s
03:36:18 ubuntu@0d1aa73ff9e0 dev-env ±|main|→
